...
public class SidePanel extends JPanel {
	 ...
	 * Serial Version UID.
	 */
	public static final long serialVersionUID = 2181495598854992747L;

	/**
	 * The dimensions of each tile on the next piece preview.
	 */
	public static final int TILE_SIZE = BoardPanel.TILE_SIZE >> 1;
	
	/**
	 * The width of the shading on each tile on the next piece preview.
	 */
	public static final int SHADE_WIDTH = BoardPanel.SHADE_WIDTH >> 1;
	 ...
	 */
	public static final int SQUARE_CENTER_X = 130;
	
	/**
	 * The center y of the next piece preview box.
	 */
	public static final int SQUARE_CENTER_Y = 65;
	
	/**
	 * The size of the next piece preview box.
	 */
	public static final int SQUARE_SIZE = (TILE_SIZE * TILE_COUNT >> 1);
	
	/**
	 * The number of pixels used on a small insets (generally used for categories).
	 */
	public static final int SMALL_INSET = 20;
	
	/**
	 * The number of pixels used on a large insets.
	 */
	public static final int LARGE_INSET = 40;
	
	/**
	 * The y coordinate of the stats category.
	 */
	public static final int STATS_INSET = 175;
	
	/**
	 * The y coordinate of the controls category.
	 */
	public static final int CONTROLS_INSET = 300;
	
	/**
	 * The number of pixels to offset between each string.
	 */
	public static final int TEXT_STRIDE = 25;
	
	/**
	 * The small font.
	 */
	public static final Font SMALL_FONT = new Font("Tahoma", Font.BOLD, 11);
